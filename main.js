  ...
  switch (piece) {
    ...
    case "bishop":
      if (
        ...
        //
        //
        // check for another second direction
        startId + width - 1 === targetId ||
        (startId + width * 2 - 2 === targetId &&
          !document.querySelector(`[square-id="${startId + width - 1}"]`)
            .firstChild) ||
    ...
    case "rook":
      if (
        ...
        //
        // check for another third direction
        //
      ...
      break;
    case "queen":
      // is able to move like both the bishop and the rook
      if (
        // first the bishop like moves
        startId + width + 1 === targetId ||
        (startId + width * 2 + 2 === targetId &&
          !document.querySelector(`[square-id="${startId + width + 1}"]`)
            .firstChild) ||
